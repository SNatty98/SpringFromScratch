...
import com.SpringFromScratch.shoppingcart.service.cart.ICartService;
...
public class CartController {
    ...
    public ResponseEntity<ApiResponse> getTotalAmount(@PathVariable Long cartId) {
        try {
            ...
            return ResponseEntity.status(NOT_FOUND).body(new ApiResponse("Total price could not be found", null));
        }
    }
}